      ...
      <div style={{ width: "80%" }}>
          ...
          <div className="answer">
            <div className="actual-answer">
              ...
              <span style={{ margin: "20px" }}>
                The methods of Promises are:
              </span>
              <ol>
                <li>
                  Promise.all() : It takes array of promises as an input and
                  promise will resolve if all the input promises are resolved,
                  if one fails it rejects the promise
                </li>
                <li>
                ...
                <li>
                  ...
                  returns a single promise as soon one of the promise is
                  fulfilled and if promises are empty or all promise are
                  rejected then it rejects the promise{" "}
                </li>
                <li>
          ...
          <div className="answer">
            <div className="actual-answer">
              <span>
                ...
                ECMAScript provides the specification on how JavaScript
        ...
        <div className="question-box">
          ...
          <div className="answer">
            <div className="actual-answer">
              <span>
                It is a transpiler which is used to convert ES6+ code to
                backward comaptible version of js so that it can be used with
                current and old browser environment
                <pre>
                  Basically it does 2 things:
                  <ol>
                    <li>
                      It transform new syntax (Ex: let a ="xyz" is converted
                      into var a ="xyz")
                    </li>
                    <li>
                      It uses polyfills to support new functions (like includes)
                    </li>
                  </ol>
                </pre>
              </span>
        ...
        <div className="question-box">
          ...
          <div className="answer">
            <div className="actual-answer">
              <span>
                Its a Module bundler which is use to bundle our code and assets
                (incuding static assets such as images) into a 'bundle' which we
                can then deploy.
                <pre>
                  Its main function is to create dependency graph so that all
                  files can be injected in proper order
                </pre>
              </span>
            </div>
          </div>
